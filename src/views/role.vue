        ...
        <el-drawer v-model="drawerPermission.show" title="授权" size="700" direction="rtl">
            ...
            <div>
                ...
                <el-button type="primary"
                    @click="copyRolePermission(drawerPermission.copyRole, drawerPermission.role)">复制角色权限</el-button>
            </div>
            <br />
            <div>
                ...
                <el-button type="primary"
                    @click="addRolePermission(drawerPermission.role, drawerPermission.selectPermissionCodes)">添加权限</el-button>
            </div>
            <br>
            <div>包含的权限： </div>
            <br>
...
const copyRolePermission = (from: String, to: Role) => {
    ...
    to.permissions = duplicate(ps, it => it.code)
    saveRole(to, it => { })
}
...
const addRolePermission = (role: Role, selectPermissionCodes: String[]) => {
    ...
    saveRole(role, it => { dp.selectPermissionCodes = [] })
}
